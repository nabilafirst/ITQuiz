...
public class AndroidB3_4 extends Activity implements View.OnClickListener, OnTouchListener {
    ...
    public void onClick(View view) {
        if (view == alert) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Untuk membuat user interface pada Android, maka kita harus membuat file xml/layout dan java.")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(AndroidB3_4.this, AndroidHome.class);
                        startActivity(intent);
                    }
                })
