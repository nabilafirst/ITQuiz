...
public class AndroidB3_5 extends Activity implements View.OnClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_android_b3_5);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(AndroidB3_5.this, AndroidHome.class);
    ...
    public void onClick(View view) {
        if (view == alert) {
            ...
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Intent digunakan untuk menghubungkan satu kegiatan dengan kegiatan lain.")
