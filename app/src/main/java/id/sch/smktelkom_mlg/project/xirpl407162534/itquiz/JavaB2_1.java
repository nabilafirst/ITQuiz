...
public class JavaB2_1 extends Activity implements View.OnClickListener, OnTouchListener {
    ...
    public void onClick(View view) {
        if (view == alert) {
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Ekstensi file hasil kompilasi pada Java yaitu .class" +
                            "Kalau berpikir .java adalah jawabannya, .java ialah ekstensi file" +
                            " java editable programnya.")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(JavaB2_1.this, JavaHome.class);
                        startActivity(intent);
                    }
                })
