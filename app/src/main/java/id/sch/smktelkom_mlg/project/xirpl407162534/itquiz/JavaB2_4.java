...
public class JavaB2_4 extends Activity implements View.OnClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_b2_4);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JavaB2_4.this, JavaB2_5.class);
    ...
    public void onClick(View view) {
        if (view == alert) {
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Keyword final digunakan untuk pendeklarasian absolut." +
                            " artinya nilainya tetap dan tidak dapat diubah. Dapat digunakan" +
                            " untuk pendeklarasian variable, class, dan method.")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(JavaB2_4.this, JavaHome.class);
                        startActivity(intent);
                    }
                })
