...
public class JavaB2_5 extends Activity implements View.OnClickListener, OnTouchListener {
    ...
    public void onClick(View view) {
        if (view == alert) {
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Tipe data char nilainya harus karakter (!*@&#*, dll.). Dan Tipe" +
                            " data String hanya dapat diisin nilai huruf.")
