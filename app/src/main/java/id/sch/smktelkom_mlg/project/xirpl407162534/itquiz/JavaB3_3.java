...
public class JavaB3_3 extends Activity implements View.OnClickListener, OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_java_b3_3);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(JavaB3_3.this, JavaB3_4.class);
    ...
    public void onClick(View view) {
        if (view == alert) {
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Jika ingin mennampilkan data sebanyak 10x misalnya," +
                            " dengan menggunakan kode for seperti ini: for(int i=10; i>=1; i--) {}")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(JavaB3_3.this, JavaHome.class);
                        startActivity(intent);
                    }
                })
