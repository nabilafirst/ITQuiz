...
public class WebB2_3 extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_web_b2_3);
        ...
        findViewById(R.id.imageViewNext).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(WebB2_3.this, WebB2_4.class);
        ...
        if (view == alert) {
            new AlertDialog.Builder(this)
                    ...
                    .setMessage("Ciri-ciri : \n" +
                            ...
                            "Desain antarmuka dibuat semenarik mungkin\n" +
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(WebB2_3.this, WebHome.class);
                        startActivity(intent);
                    }
                })
