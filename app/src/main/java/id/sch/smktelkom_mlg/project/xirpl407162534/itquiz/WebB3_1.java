...
public class WebB3_1 extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onClick(View view) {
        if (view == alert) {
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Cara pemanggilan alamat file php yang benar adalah localhost://nama_folder/nama_file yang diketikan pada web browser")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(WebB3_1.this, WebHome.class);
                        startActivity(intent);
                    }
                })
