...
public class WebB3_4 extends Activity implements View.OnClickListener, View.OnTouchListener {
    ...
    public void onClick(View view) {
        if (view == alert) {
            new AlertDialog.Builder(this)
                    .setTitle("Penjelasan")
                    .setMessage("Untuk menulis komentar 1 baris maka ditulis : //komentar")
        ...
        new AlertDialog.Builder(this)
                ...
                .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int id) {
                        Intent intent = new Intent(WebB3_4.this, WebHome.class);
                        startActivity(intent);
                    }
                })
